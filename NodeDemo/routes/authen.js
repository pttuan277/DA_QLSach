...
//   // Chuyển hướng đến trang user.ejs sau khi đăng nhập thành công
//   res.redirect('/users'); // Đổi '/user' thành đường dẫn thích hợp

//   // Hoặc res.redirect('/users/' + result.userID); nếu bạn muốn truyền thêm thông tin người dùng
// });
